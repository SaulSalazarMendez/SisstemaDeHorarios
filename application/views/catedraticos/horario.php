...
<head> 
    ...
    <meta name="author" content="Sa̼l Salazar M̩ndez">
    <!--[if IE]>
...
<form name="formulario" method="post" action="<?=base_url()?>index.php/catedratico/guardaCalendario">
<input name='maestro_id' value='<?=$sigid?>' hidden >
...
<div>
<button type='submit' class='btn btn-primary' id='boton_guardar' >Guardar</button>
</div>
	 </form>
	 </div>
	</body>
	...
	<script>
		...
		/*function myFunction() {
		    document.getElementById("boton_guardar").style = 'position:absolute; bottom: 50px; right: 50px;';
		}*/
		<?php 
		if ($pila!=false){
