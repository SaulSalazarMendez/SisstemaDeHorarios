...
<body>
<form name="formulario" method="post" action="guarda.php">
	
	<div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading">
  Horario <button type='submit' class='btn btn-primary'>Guardar</button>
  <a href='cancelar.php' class='btn btn-danger'>Cancelar</a>
  </div>
...
?>	
	...
	foreach ($dias as $dia){ ?>
		...
		<input id='<?=$dia?><?=$con?>' value='0' hidden></td>
